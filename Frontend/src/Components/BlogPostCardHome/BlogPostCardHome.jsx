...
const BlogPostCardHome = ({post}) => {
    ...
    const handleDelete = async (id) =>{
        ...
        try{
           const res = await axios.delete(`http://localhost:8001/api/posts/delete-post/${id}`);
    ...
    const handleLikeDislike = async (postId) =>{
        ...
        try{
            const res = await axios.post(`http://localhost:8001/api/posts/like-dislike/${postId}`, {userId : activeUser._id });
